...
describe('Image', () => {
  test('should render correctly with local path Image', () => {
    const props = {
      testID: 'myImage',
      source: WPImage,
      height: 200,
  ...
  test('sould match snapshot', () => {
    ...
    const {toJSON} = render(<Image {...props} />);
